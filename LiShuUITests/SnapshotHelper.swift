...
/// XCTest 的 `setUpWithError` 等回调**可能不在主线程**。`MainActor.assumeIsolated` 在错误线程会直接 trap，导致用例约 0.x 秒失败。
private func runSnapshotWorkOnMainThread(_ work: () -> Void) {
