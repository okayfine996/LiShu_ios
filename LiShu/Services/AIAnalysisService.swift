...
final class AIAnalysisService {
    ...
    func splitIntoBatches(_ lines: [(text: String, confidence: Float)], maxCharsPerBatch: Int) -> [[(text: String, confidence: Float)]] {
    ...
    func buildPrompt(from lines: [(text: String, confidence: Float)]) -> String {
        ...
        1. name: 人名（2-6个汉字）
        2. amount: 金额（数字，单位元）
        3. eventType: 该条记录对应的事件类型，只能是以下之一：wedding, engagement, funeral, birth, birthday, longevity, festival, property, education, business, promotion, visit, other
