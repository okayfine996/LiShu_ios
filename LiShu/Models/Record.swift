...
final class Record {
    ...
    init(
        ...
        relationshipWeightRaw = relationshipWeight.rawValue
        createdAt = .now
...
enum RelationshipWeight: String, Codable, CaseIterable {
    ...
    nonisolated var displayName: String {
        ...
        case .reciprocal: String(localized: "record.relationshipWeight.reciprocal")
        case .support: String(localized: "record.relationshipWeight.support")
        case .profound: String(localized: "record.relationshipWeight.profound")
        }
    }
}
...
enum RecordType: String, Codable, CaseIterable {
    ...
    var iconName: String {
        switch self {
        case .monetary: "yensign.circle"
        case .gift: "gift"
        case .favor: "hands.sparkles"
        case .banquet: "fork.knife"
        }
    }
...
extension Record {
    ...
    var resolvedTypeData: RecordTypeData {
        if let cached = _cachedTypeData { return cached }
        let result = decodeTypeData()
        _cachedTypeData = result
        return result
    }

    private func decodeTypeData() -> RecordTypeData {
