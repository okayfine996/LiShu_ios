...
private struct RecordDetailDirectionTag: View {
...
private struct RecordDetailTypeTag: View {
...
private struct RecordDetailAmountCell: View {
    let label: String
    let value: String
...
private struct RecordDetailLabeledValueRow: View {
    let title: String
    let value: String
...
private struct RecordDetailInfoDivider: View {
    var body: some View {
        Divider()
...
private struct RecordDetailAmountCellModel: Identifiable {
    let id = UUID()
    let label: String
    let value: String
}
