...
struct SubscriptionManagerTests {
    ...
    func testCanAddRecordUnderLimit() throws {
        let db = try TestDB()
    ...
    func testCanAddRecordAtLimit() throws {
        let db = try TestDB()
    ...
    func testCanAddContactUnderLimit() throws {
        let db = try TestDB()
        let manager = SubscriptionManager.shared
    ...
    func testCanAddContactAtLimit() throws {
        let db = try TestDB()
    ...
    func testCurrentSubscriptionNameNil() {
        let manager = SubscriptionManager.shared
