...
struct StatisticsViewModelTests {
    ...
    func testLoadWithData() throws {
        ...
        db.context.insert(c)
        db.context.insert(e)
        let rGiven = Record(contact: c, event: e, amount: 1000, direction: .given, paymentMethod: .cash, returnedAmount: 0, date: recordDate)
        let rReceived = Record(contact: c, event: e, amount: 500, direction: .received, paymentMethod: .cash, returnedAmount: 0, date: recordDate)
    ...
    func testMonthlyData() throws {
        ...
        db.context.insert(c)
        db.context.insert(e)
        let rMarGiven = Record(contact: c, event: e, amount: 300, direction: .given, paymentMethod: .cash, returnedAmount: 0, date: marDate)
        let rMarReceived = Record(contact: c, event: e, amount: 100, direction: .received, paymentMethod: .cash, returnedAmount: 0, date: marDate)
        let rJunGiven = Record(contact: c, event: e, amount: 500, direction: .given, paymentMethod: .cash, returnedAmount: 0, date: junDate)
    ...
    func testTopContacts() throws {
        ...
        for c in [c1, c2, c3, c4, c5] {
            let r = Record(contact: c, event: e, amount: 100, direction: .given, paymentMethod: .cash, returnedAmount: 0, date: recordDate)
            db.context.insert(r)
        }
        try db.context.save()
    ...
    func testSelectYear() throws {
        ...
        db.context.insert(c)
        db.context.insert(e)
        let r2025 = Record(contact: c, event: e, amount: 1000, direction: .given, paymentMethod: .cash, returnedAmount: 0, date: date2025)
        let r2026 = Record(contact: c, event: e, amount: 2000, direction: .given, paymentMethod: .cash, returnedAmount: 0, date: date2026)
    ...
    func testContactsSortedByIncome() throws {
        ...
        db.context.insert(e)
        let r1 = Record(contact: c1, event: e, amount: 100, direction: .received, paymentMethod: .cash, returnedAmount: 0, date: recordDate)
        let r2 = Record(contact: c2, event: e, amount: 500, direction: .received, paymentMethod: .cash, returnedAmount: 0, date: recordDate)
        let r3 = Record(contact: c3, event: e, amount: 300, direction: .received, paymentMethod: .cash, returnedAmount: 0, date: recordDate)
        db.context.insert(r1)
        db.context.insert(r2)
