            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 1) {
                    Text(String(localized: "widget.netAmount"))
                        ...
                        .textCase(.uppercase)
                        .foregroundStyle(WidgetPalette.textSecondary)
                    WidgetNetAmountDisplay(amount: snapshot.netAmount)
                }
                .padding(.top, 8)
                ...
                LazyVGrid(
                    ...
                    WidgetFinancialBar(label: String(localized: "widget.income"), value: snapshot.yearlyIncome, ratio: snapshot.incomeRatio, color: WidgetPalette.gold)
                    WidgetFinancialBar(label: String(localized: "widget.expense"), value: snapshot.yearlyExpense, ratio: snapshot.expenseRatio, color: WidgetPalette.accent)
                }
                .padding(.top, 10)
                ...
                HStack(spacing: 10) {
                    WidgetStatItem(dot: WidgetPalette.accent, label: String(localized: "widget.stat.interactions"), value: "\(snapshot.yearlyRecordCount)", unit: String(localized: "widget.stat.unit.records"))
                    WidgetStatItem(dot: WidgetPalette.gold, label: String(localized: "widget.stat.contacts"), value: "\(snapshot.yearlyContactCount)", unit: String(localized: "widget.stat.unit.contacts"))
                    if snapshot.pendingReturnCount > 0 {
                        WidgetStatItem(dot: WidgetPalette.accentDark, label: String(localized: "widget.stat.pendingReturn"), value: "\(snapshot.pendingReturnCount)", unit: String(localized: "widget.stat.unit.records"))
                    }
                }
                .padding(.top, 8)
            }
